...
CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -O3 -Wall -Werror=return-type -fno-rtti -fno-threadsafe-statics -fno-exceptions  -std=gnu++11 -ffunction-sections -fdata-sections -ffast-math $(DEFINES)
